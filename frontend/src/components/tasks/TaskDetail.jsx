...
export default function TaskDetail({ task, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-slate-950/40 backdrop-blur-sm animate-fade-in-up">
      <div className="h-full w-full max-w-md overflow-y-auto border-l border-slate-800 bg-slate-950/90 backdrop-blur-xl p-6 shadow-2xl flex flex-col justify-between animate-slide-in-right">
        <div>
          {/* Header */}
