...
async def startup():
    ...
    # Only clear database tables on startup if explicitly requested via environment variable.
    # This prevents Render restarts/spin-downs from wiping persistent database data.
